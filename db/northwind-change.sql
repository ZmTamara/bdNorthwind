...
CREATE DEFINER=`root`@`localhost` PROCEDURE `spu_orders_del` (IN `p_OrderID` INT)   BEGIN
    DELETE FROM orders
...
CREATE TABLE `administradores` (
  ...
  `user_adm` varchar(50) DEFAULT NULL,
...
INSERT INTO `administradores` (`id_user`, `user_adm`, `pass_adm`) VALUES
(1, 'administrador', 'contraseña');
